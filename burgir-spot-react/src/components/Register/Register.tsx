...
const Register = () => {
    ...
    const onSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        let data = Object.fromEntries(formData) as any; // can't find another solution
        ...
        <div className="container" style={{ marginTop: "5%" }}>
            <section className="content-wraper" style={{ margin: "auto" }}>
                ...
                >
                    ...
                    <input
                        ...
                        style={{
                            ...
                            ...(email === "" && isSubmitted
                                ...
                                : null),
                            ...(!emailRegex.test(email) && isSubmitted
                                ? utils.inputBorderStyle.error
                                : null),
                            ...(usedEmailState
                                ? utils.inputBorderStyle.error
                    ...
                    {!emailRegex.test(email) && isSubmitted
                        ? utils.inputValidErr("Email")
                        : ""}
                    {usedEmailState ? utils.usedErr("Email") : ""}
                    <label htmlFor="username" style={{ marginTop: "5px" }}>
                        Username
                    </label>
                    <input
                        type="text"
                    ...
                    {username === "" && isSubmitted
                        ...
                        : ""}
                    {username.length < 5 && isSubmitted
                        ? utils.inputLengthErr("Username", 5)
                        : ""}
                    {usedUsernameState ? utils.usedErr("Username") : ""}
                    <label htmlFor="telephone" style={{ marginTop: "5px" }}>
                        Telephone
                    </label>
                    <input
                        type="tel"
                        ...
                        style={{
                            ...
                            ...(telephoneHover
                                ? utils.inputBorderStyle.hover
                                : null),
                            ...(telephone === "" && isSubmitted
                                ? utils.inputBorderStyle.error
                                : null),
                            ...(!telephoneRegex.test(telephone) && isSubmitted
                                ? utils.inputBorderStyle.error
                                : null),
                        }}
                    />
                    {telephone === "" && isSubmitted
                        ? utils.inputErr("telephone")
                        : ""}
                    {!telephoneRegex.test(telephone) && isSubmitted
                        ? utils.inputValidErr("Telephone")
                        : ""}
                    {usedTelephone && isSubmitted
                        ? utils.usedErr("Telephone")
                        : ""}
                    ...
                    {password === "" && isSubmitted
                        ...
                        : ""}
                    {password.length < 4 && isSubmitted
                        ? utils.inputLengthErr("Password", 4)
                        : ""}
                    <label htmlFor="repassword" style={{ marginTop: "5px" }}>
                        Repeat password
                    </label>
                    <input
                        type="password"
                        ...
                        style={{
                            ...
                            ...(repeatPassword === "" && isSubmitted
                                ? utils.inputBorderStyle.error
                                : null),
                            ...(password !== repeatPassword && isSubmitted
                                ? utils.inputBorderStyle.error
                                : null),
                        }}
                    />
                    {repeatPassword === "" && isSubmitted
                        ? utils.inputErr("repeat password")
                        : ""}
                    {password !== repeatPassword && isSubmitted ? (
                        <p style={{ color: "red" }}>
